...
from transformers import Trainer, is_datasets_available, is_torch_tpu_available, TrainerCallback
...
class QuestionAnsweringTrainer(Trainer):
    ...
    def predict(self, test_dataset, test_examples, ignore_keys=None, metric_key_prefix: str = "test"):
